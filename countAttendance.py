...
#to loop over the each row in batches of 5
...
for (q, i) in enumerate(np.arange(0, len(questionCnts), 5)):
	...
	print "Number of Marked circle in line " +str(q+1) +" is: " +str(countAtt)
	# initialize the contour color and the index of the correct answer
	color = (0, 0, 255)

	# draw the outline of the highest shaded 
	#cv2.drawContours(image, [cnts[bubbled[1]]], -1, color, 3)



cv2.putText(image, "Absentees", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 255), 2)
